...
public class Bear extends Predator {
    ...
    @Override
    public Class<? extends Animal> getAnimalClass() { return Bear.class; }
    @Override
    public Color getColor() { return AnimalColorMapper.getColor(Bear.class); }
    @Override
    ...
    protected Animal createNewOffspring() {
        try {
            ...
            System.err.println("Error creating new Bear instance: " + e.getMessage());
            return null;
        }
    }
    ...
    protected List<Class<? extends Animal>> getFoodSources() {
        return Arrays.asList(
                Rabbit.class,
                Boar.class, Deer.class, Goat.class, Horse.class, Sheep.class,
                Duck.class
        );
    }
}