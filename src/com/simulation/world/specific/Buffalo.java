...
public class Buffalo extends Herbivore {
    ...
    @Override
    public Class<? extends Animal> getAnimalClass() { return Buffalo.class; }
    @Override
    public Color getColor() { return AnimalColorMapper.getColor(Buffalo.class); }
    @Override
    ...
    protected Animal createNewOffspring() {
        try {
            Buffalo calf = new Buffalo();
            return calf;
        } catch (Exception e) {
            System.err.println("Error creating new Buffalo instance: " + e.getMessage());
            return null;
        }
    }
    @Override
