...
public class Deer extends Herbivore {
    ...
    @Override
    public Class<? extends Animal> getAnimalClass() { return Deer.class; }
    @Override
    public Color getColor() { return AnimalColorMapper.getColor(Deer.class); }
    @Override
    ...
    protected Animal createNewOffspring() {
        try {
            ...
            System.err.println("Error creating new Deer instance: " + e.getMessage());
            return null;
        }
    }
    @Override
