...
public class Duck extends Herbivore {
    ...
    @Override
    public Class<? extends Animal> getAnimalClass() { return Duck.class; }
    @Override
    public Color getColor() { return AnimalColorMapper.getColor(Duck.class); }
    @Override
    ...
    protected Animal createNewOffspring() {
        try {
            ...
            System.err.println("Error creating new Duck instance: " + e.getMessage());
            return null;
        }
    }
    @Override
