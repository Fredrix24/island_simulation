...
public class Goat extends Herbivore {
    ...
    @Override
    public Class<? extends Animal> getAnimalClass() { return Goat.class; }
    @Override
    public Color getColor() { return AnimalColorMapper.getColor(Goat.class); }
    @Override
    ...
    protected Animal createNewOffspring() {
        try {
            ...
            System.err.println("Error creating new Goat instance: " + e.getMessage());
            return null;
        }
    }
    @Override
