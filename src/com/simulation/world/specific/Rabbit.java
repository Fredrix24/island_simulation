...
public class Rabbit extends Herbivore {
    ...
    @Override
    public Class<? extends Animal> getAnimalClass() { return Rabbit.class; }
    @Override
    public Color getColor() { return AnimalColorMapper.getColor(Rabbit.class); }
    @Override
    ...
    protected Animal createNewOffspring() {
        try {
            ...
            System.err.println("Error creating new Rabbit instance: " + e.getMessage());
            return null;
        }
    }
    @Override
